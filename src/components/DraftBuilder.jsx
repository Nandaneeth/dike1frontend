...
const DraftBuilder = ({ onClose }) => {
    return (
        <div className="bg-[#0d0e10] rounded-3xl p-6 flex flex-col h-full shadow-2xl relative animate-in slide-in-from-right duration-300 border border-white/5">
            {/* Header */}
            <div className="flex justify-between items-center mb-4 border-b border-white/10 pb-4">
                <div className="flex items-center gap-2">
                    ...
                    <h2 className="text-xl font-bold text-gray-100">Draft Builder</h2>
                </div>
                <div className="flex items-center gap-2">
                    <button className="text-sm border border-white/20 rounded-full px-4 py-1.5 hover:bg-white/5 transition-colors font-medium text-gray-300">
                        Export as PDF
                    </button>
            ...
            <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar">
                <div
                    className="prose prose-lg max-w-none focus:outline-none text-gray-300"
                    style={{ fontFamily: 'Times New Roman, serif' }}
                    contentEditable
                    suppressContentEditableWarning
                >
                    <h1 className="text-3xl font-bold text-blue-400 mb-4">Legal Analysis of Public Urination and Lying to Police in India</h1>
                    ...
                    <h3 className="text-xl font-bold text-gray-100 mt-6 mb-2">Direct Answer:</h3>
                    <p className="mb-4">
                    ...
                    <h3 className="text-xl font-bold text-gray-100 mt-6 mb-2">Legal Provisions and Applicability:</h3>

                    <h4 className="text-lg font-bold text-gray-200 mt-4 mb-2">Indian Penal Code Section 294 - Obscene Acts and Songs:</h4>
