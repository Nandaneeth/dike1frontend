...
const Settings = ({ onClose }) => {
    ...
    return (
        <div className="w-full h-full flex bg-[#131416]">
            {/* Left Sidebar */}
                    ...
                    <div className="space-y-8 max-w-2xl">
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                <div>
                                    <p className="text-gray-300 text-sm mb-3">Color mode</p>
                                    <div className="flex gap-4">
                                        {['Light', 'Auto', 'Dark'].map((mode) => (
                                            <button
                                                key={mode}
                                                className="flex flex-col items-center gap-2 p-3 rounded-lg border border-white/10 hover:border-white/30 transition-colors group"
                                            >
                                                ...
                                                <span className="text-sm text-gray-300 group-hover:text-white">{mode}</span>
                                            </button>
                                        ))}
                                    </div>
                                </div>
                        ...
                        <div>
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/10">
                                    <div>
                                        <p className="text-gray-300 font-medium">Response completions</p>
                                        <p className="text-gray-500 text-sm">Get notified when Dike has finished a response.</p>
                                    </div>
                                    <div className="w-12 h-7 bg-blue-500 rounded-full cursor-pointer relative flex items-center justify-end pr-1">
                    ...
                    <div className="space-y-8 max-w-2xl">
                        ...
                        <div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <input
                                            type="text"
                                            defaultValue="Pranav"
                                            className="flex-1 bg-[#1e1f23] border border-white/10 text-gray-300 text-sm rounded-lg px-4 py-2 focus:outline-none focus:border-white/30"
                                        />
                                    </div>
                                </div>
                                ...
                                {/* Claude Name */}
                                <div>
                                    <label className="text-gray-400 text-sm block mb-2">What should Claude call you?</label>
                                    <input
                                        type="text"
                                        defaultValue="Pranav"
                                        className="w-full bg-[#1e1f23] border border-white/10 text-gray-300 text-sm rounded-lg px-4 py-2 focus:outline-none focus:border-white/30"
                                    />
                                </div>

                                {/* Work Function */}
                                <div>
                                    <label className="text-gray-400 text-sm block mb-2">What best describes your work?</label>
                                    <select className="w-full bg-[#1e1f23] border border-white/10 text-gray-300 text-sm rounded-lg px-4 py-2 focus:outline-none focus:border-white/30">
